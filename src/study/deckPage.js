import { loadState, saveState, buildDeckTree, listDecks, resolveDeck, loadIndex, button } from "./shared.js";
...
export function renderDeckPage() {
  ...
  function allRow() {
    return entry(contentRow(ICONS.layers, "All cards", currentTotal, "deck-row--all"), useButton("all", "All cards"));
  }
  ...
  async function initialize() {
    try {
      ...
      currentTotal = resolveDeck(index, "all").count;
      seedExpanded(index);
      renderList();
    } catch (error) {
